...
TRACE_EVENT(sched_blocked_reason,
	...
	TP_printk("pid=%d iowait=%d caller=%pS%pS%pS%pS%pS%pS%pS%pS%pS%pS", __entry->pid, __entry->io_wait,
		  (void *)__entry->caller,
		  (void *)__entry->caller1,
		  (void *)__entry->caller2,
		  (void *)__entry->caller3,
		  (void *)__entry->caller4,
		  (void *)__entry->caller5,
		  (void *)__entry->caller6,
		  (void *)__entry->caller7,
		  (void *)__entry->caller8,
