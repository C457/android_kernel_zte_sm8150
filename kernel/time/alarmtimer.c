...
/*zte_pm 20190830 show qpnp_rtc_alarm info when irq wakeup ap - beigin*/
static int enable_timer_log = 0;
module_param_named(enable_timer_debug, enable_timer_log, int, S_IRUGO | S_IWUSR | S_IWGRP);
...
/*zte_pm 20190830 show qpnp_rtc_alarm info when irq wakeup ap - end*/
...
void alarm_start(struct alarm *alarm, ktime_t start)
{
	...
	/*zte_pm 20190830 show qpnp_rtc_alarm info when irq wakeup ap - begin*/
