...
{
	if (strncmp(GTP_IC_TYPE, "GT8110", 6) && strncmp(GTP_IC_TYPE, "GT8105", 6)
		&& strncmp(GTP_IC_TYPE, "GT801", 5)
		&& strncmp(GTP_IC_TYPE, "GT800", 5)
		&& strncmp(GTP_IC_TYPE, "GT801PLUS", 9)
		&& strncmp(GTP_IC_TYPE, "GT811", 5)
		&& strncmp(GTP_IC_TYPE, "GTxxx", 5)
		&& strncmp(GTP_IC_TYPE, "GT9XX", 5)) {
	...
	const char __user *buff, size_t len, loff_t *off)
{
	...
	if (cmd_head.wr == 1) {
		...
		memcpy(GTP_IC_TYPE, cmd_head.data, cmd_head.data_len);
	...
	char __user *page, size_t size, loff_t *ppos)
{
	...
	if (cmd_head.wr % 2)
		...
		ret = simple_read_from_buffer(page, size, ppos, GTP_IC_TYPE, sizeof(GTP_IC_TYPE));
		return ret;
